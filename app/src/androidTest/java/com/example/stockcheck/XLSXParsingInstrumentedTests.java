...
public class XLSXParsingInstrumentedTests {
    ...
    public void Setup() {
        if (!setupDone) {
            ...
            Uri categoriesUri = new Uri.Builder()
                    ...
                    .build();
            try {
                categoriesTyreList = XLSXReader.Read(categoriesUri, context);
            } catch (Exception ignored) {}
            // Parse XLSX without categories
            Uri noCategoriesUri = new Uri.Builder()
                    .scheme(ContentResolver.SCHEME_ANDROID_RESOURCE)
                    .authority("com.example.stockcheck.test")
                    .appendPath("raw")
                    .appendPath("test_xlsx_without_categories")
                    .build();
            try {
                noCategoriesTyreList = XLSXReader.Read(noCategoriesUri, context);
            } catch (Exception ignored) {}
    ...
    @Test
    public void Parse_XLSX_Categories_Correct_Supplier_Part_Code() {
        assertTrue(categoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_Categories_Correct_Description() {
        assertTrue(categoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_Categories_Correct_Location() {
        assertTrue(categoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_Categories_Correct_Stock() {
        assertTrue(categoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_Categories_Correct_Last_Sold_Date() {
        assertTrue(categoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_No_Categories_Correct_Part() {
    ...
    @Test
    public void Parse_XLSX_No_Categories_Correct_Supplier_Part_Code() {
        assertTrue(noCategoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_No_Categories_Correct_Description() {
        assertTrue(noCategoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_No_Categories_Correct_Location() {
        assertTrue(noCategoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_No_Categories_Correct_Stock() {
        assertTrue(noCategoriesTyresNotNull);
    ...
    @Test
    public void Parse_XLSX_No_Categories_Correct_Last_Sold_Date() {
        assertTrue(noCategoriesTyresNotNull);
